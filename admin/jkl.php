...
if(isset($_POST["id"]))
{
	$conn = mysqli_connect("localhost", "root", "", "pos");
	$result = '';
	$query = "SELECT noid, noref, idlay, totalbyr, denda, FROM trx_pdam WHERE idkab ='".$_POST["id"]."'";
...
if(isset($_POST["id"]))
{
  ...
  $resultt = '';
  $queryy = "SELECT COUNT(idkab) as idkab, SUM(totalbyr) as 'totalbyr', SUM(denda) as 'denda', SUM (totalbyr+denda) as 'total' FROM trx_pdam WHERE idkab ='".$_POST["id"]."'";
