...
if(isset($_POST["id"]))
{
  $conn = mysqli_connect("localhost", "root", "", "pos");
  $result = '';
  $query = "SELECT COUNT(noid) as 'jumlah', noref, noid, SUM(totalbyr) as 'totalbyr', SUM(denda) as denda, SUM(totalbyr+denda) as 'total' FROM trx_pdam WHERE noid ='".$_POST["id"]."' GROUP BY noref";
...
if(isset($_POST["id"]))
{
  $conn = mysqli_connect("localhost", "root", "", "pos");
  $result = '';
  $query = "SELECT noref, noid, totalbyr, denda FROM trx_pdam WHERE noid ='".$_POST["id"]."'";
