...
<form onKeyUp="highlight(event)" onClick="highlight(event)" name="form" id="form" class="form" action="module/ubah_password.php" onsubmit="return cek(this)" method="post">
